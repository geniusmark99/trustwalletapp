...
<header class="light-bb">
    ...
    <a class="navbar-brand" href="index.html"><img src="assets/img/trustwalletlogo.svg" alt="logo"></a  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#headerMenu"
